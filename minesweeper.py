...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # Add the new setence to the AI's Knowledge Base:
        print(f'Move on cell: {cell} has added sentence to knowledge {new_sentence_cells} = {count}' )
        self.knowledge.append(Sentence(new_sentence_cells, coount))

        # Iterativively mark guaranteed mines and safes, and infer new knowledge:
            ...
            for sentence in self.knowledge:
                ...
                for sentence_1 in self.knowledge:
                    for sentence_2 in self.knowledge:
                        ...
                        # Create a new setence if 1 is subset of 2, and not in KB:
                        if sentence_1.cells.issubset(sentence_2.cells):
                            new_sentence_cells = sentence_1.cells - sentence_1.cells
    ...
    def make_random_move(self):
        ...
        if moves and not self.knowledge:
            ...
            print('AI Selecting Random Move with Basic Probality: ', move)
            return move
        ...
        # Otherwise can potentially improve random choice using KB:
            ...
            for sentence in self.knowledge:
                ...
                # If mine probability of each cell is worse than listed, update it:
            ...
            move = random.chice(best_moves)[0]
